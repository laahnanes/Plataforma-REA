...
class Ui_Cadastro(object):
    def setupUi(self, Cadastro):
        ...
        self.curso = QLabel(Cadastro)
        self.curso.setObjectName(u"curso")
        self.curso.setGeometry(QRect(300, 590, 81, 41))
        self.curso.setFont(font1)
        ...
        self.cb_curso = QComboBox(Cadastro)
        self.cb_curso.addItem("")
        self.cb_curso.addItem("")
        self.cb_curso.setObjectName(u"cb_curso")
        self.cb_curso.setGeometry(QRect(387, 590, 210, 41))
        font2 = QFont()
        font2.setFamily(u"Biko")
        font2.setPointSize(12)
        self.cb_curso.setFont(font2)
        ...
        self.disciplina = QLabel(Cadastro)
        self.disciplina.setObjectName(u"disciplina")
        self.disciplina.setGeometry(QRect(300, 520, 270, 41))
        self.disciplina.setFont(font1)
        ...
        self.cb_disciplina = QComboBox(Cadastro)
        self.cb_disciplina.addItem("")
        self.cb_disciplina.addItem("")
        self.cb_disciplina.addItem("")
        self.cb_disciplina.addItem("")
        self.cb_disciplina.addItem("")
        self.cb_disciplina.addItem("")
        self.cb_disciplina.setObjectName(u"cb_disciplina")
        self.cb_disciplina.setGeometry(QRect(580, 520, 250, 41))
        font2 = QFont()
        font2.setFamily(u"Biko")
        font2.setPointSize(12)
        self.cb_disciplina.setFont(font2)
        
        # Tirando a visibilidade dos atributos de professor no começo
        self.especialidade.setVisible(False)
        self.txt_especialidade.setVisible(False)
        self.disciplina.setVisible(False)
        self.cb_disciplina.setVisible(False)
        ...
        self.cb_curso.raise_()
        self.especialidade.raise_()
        self.disciplina.raise_()
        self.txt_especialidade.raise_()
        self.cb_disciplina.raise_()
    ...
    def atualizarVisibilidade(self, index):
        if index == 0:  # Aluno selecionado
            ...
            self.curso.setVisible(True)
            self.cb_curso.setVisible(True)
            ...
            self.curso.setVisible(False)
            self.cb_curso.setVisible(False)

            # Mostrar campos de professor
            self.especialidade.setVisible(True)
            self.txt_especialidade.setVisible(True)
            self.disciplina.setVisible(True)
            self.cb_disciplina.setVisible(True)
    # setupUi
    ...
    def retranslateUi(self, Cadastro):
        ...
        self.curso.setText(QCoreApplication.translate("Cadastro", u"Curso:", None))
        self.cb_curso.setItemText(0, QCoreApplication.translate("Cadastro", u"Eng. de Software", None))
        self.cb_curso.setItemText(1, QCoreApplication.translate("Cadastro", u"Lic. em Computação", None))
        self.especialidade.setText(QCoreApplication.translate("Cadastro", u"Especialidade:", None))
        self.disciplina.setText(QCoreApplication.translate("Cadastro", u"Disciplina vinculada:", None))
        self.cb_disciplina.setItemText(0, QCoreApplication.translate("Cadastro", u"Projeto de Software", None))
        self.cb_disciplina.setItemText(1, QCoreApplication.translate("Cadastro", u"Programação 3", None))
        self.cb_disciplina.setItemText(2, QCoreApplication.translate("Cadastro", u"Segurança de Sistemas", None))
        self.cb_disciplina.setItemText(3, QCoreApplication.translate("Cadastro", u"Didática 1", None))
        self.cb_disciplina.setItemText(4, QCoreApplication.translate("Cadastro", u"Introdução a Computação", None))
        self.cb_disciplina.setItemText(5, QCoreApplication.translate("Cadastro", u"IHC", None))
